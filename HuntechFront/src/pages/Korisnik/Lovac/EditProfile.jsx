...
const EditProfile = () => {
  const [formData, setFormData] = useState({
    ...
    trofeji: 'Srndać – 2024-05-03 – Karabin .308\nVuk – 2023-11-18 – Puska 30-06',
  });
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      <input type="file" name="profilnaSlika" accept=".jpg,.jpeg,.png" onChange={handleChange} />

      <label>Lovacka udruženja (razdvojena zarezom):</label>
      <input type="text" name="udruzenja" value={formData.udruzenja} onChange={handleChange} />
      ...
      <label>Trofeji (format: Životinja – datum – oružje; po jedan po liniji):</label>
      <textarea name="trofeji" rows="4" value={formData.trofeji} onChange={handleChange} />
